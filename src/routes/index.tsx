...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Chrome-tanned wet blue hides — bovine, buffalo, goat and sheep — supplied to tanneries across the country with reliable grading and consistent quality." },
